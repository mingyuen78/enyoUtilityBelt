 /************************************************************************************
    ...
    Depends : ./assets/img/GMapPin/GMap_Marker.png
 		...
 		if ( this.$.map.hasNode() ){
            ...
            if (this.markerPosition.length){
                ...
                for (var i = 0; i < this.markerPosition.length; i++) {
                    var image = new google.maps.MarkerImage("./assets/csskit/img/gMapMarker.png", null, null, null, new google.maps.Size(20,34));
